...
<my:layout1Column>
	...
	<form action="/lab9/doUpdateAd.jsp" method="post"><%-- Если переданный параметр id больше нуля (т.е. мы редактируем объявление),
то сохранить его в невидимом поле --%> <c:if test="${param.id>0}">
	...
	<table body="0" cellspacing="0" cellpadding="10" width="90%">
		...
		<tr>
			...
			<td><textarea name="body" rows="10" " style="width: 90%"><c:out
				value="${sessionScope.adData.body}" /></textarea></td>
		</tr>
