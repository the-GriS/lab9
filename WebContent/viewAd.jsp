...
<my:layout1Column>
	...
	<div style="text-decoration: italic; font-size: 10px">Автор: <c:out
		value="${ad.author.name}" />, последняя дата редактирования: <fmt:formatDate
		pattern="hh:mm:ss dd-MM-yyyy" value="${ad.lastModifiedDate}" /></div>
